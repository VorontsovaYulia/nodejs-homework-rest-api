...
const register = async (req, res) => {
  ...
  const varifyEmail = {
    ...
    html: `<a target="_blank" href="${BASE_URL}/users/verify/${verificationToken}">Click varify email </a>`,
  };
...
const resendVerifyEmail = async (req, res) => {
  ...
  const varifyEmail = {
    to: email,
    subject: "Varify email",
    html: `<a target="_blank" href="${BASE_URL}/users/verify/${user.verificationToken}">Click varify email </a>`,
  };
